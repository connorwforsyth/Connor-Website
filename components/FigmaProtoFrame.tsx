...
export default function FigmaProtoFrame({ src, className, image }: FigmaProtoFrameProps) {
  return (
...
{image ? <Image src={src} alt="image" width={1440} height={1024} className="relative aspect-[1440/1024] w-full overflow-clip bg-white" /> : <iframe
