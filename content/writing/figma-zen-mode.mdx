...
You can see implementations of this in tools like [Webflow](https://webflow.com), [Linear](https://linear.app), [Miro](https://miro.com) and of course [Raycast](https://raycast.com). Many of these are using Paco Coursey's [⌘K](https://cmdk.paco.me/) under the hood.
