...
| _Practices_             | _Tools_                | _Links_                                   |
|-----------------------|----------------------|-----------------------------------------|
| Wayfinding            | Miro                 | [servdes2020.org](http://servdes2020.org) |
| Wireframing           | Adobe Illustrator    | [gather.town](https://www.gather.town)   |
| Visual Design         | Gather.Town          |                                         |
| Experience Design     | Google Sheets        |                                         |
| Storyboarding         |                      |                                         |
| Prototyping           |                      |                                         |
...
![Socialization asset of the map to encourage interaction before and after each event.](../images/singage-banner.png)
