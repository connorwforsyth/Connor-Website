...
- How can we reuse more of our existing workshop material across projects?
```
...
I found interest in this challenge and began to explore and document some of the strategies that I had been observing and using across the organisation. This began as a personal passion project, but quickly grew into a series of living boards that our organisation would turn to when working and building boards in Miro.
...
It eventually evolved into a global resource that our organisation would turn to when looking up resources and standards for how workshops should be run.
