...
Our research explored some of the signals leading to how LLMs are introducing a new category of technology material that may only exist as a backend, and orchestrated through centralised interfaces that may not be through through boxes on a screen, but through integrated experiences across the user's digital and physical environments. 
