...
Our idea was to build an offering that lets clients workshop challenge areas with us, kickstart a future relationship, and come away with something useful.

We first explored the idea with a pitch for our sales team.
...
## UI design
In an effort to make this product offering more _real_, we crafted a landing page to support inbound opportunities. Exploring a product idea through different artefacts helps legitimise the concept for others.

<Person name="Amalie Judd"/> and <Person name="Alec Gozali"/> stepped in to support with UI and prototyping for this effort.
