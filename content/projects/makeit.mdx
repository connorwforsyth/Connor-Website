...
<MDXCarousel>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-0.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-1.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-2.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-3.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-4.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-5.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-6.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-7.png"/>
<Img className="bg-gradient-to-tr from-blue-900 to-blue-950" src="/projects/makeit/pitchdeck/Structural-Slides-8.png"/>
</MDXCarousel>

Initially we thought of just including a PDF to assist the sales team.
But we opted to also craft a website to help capture inbound leads.
Experimental one off websites are new for Designit, however we found it useful to centralise the experiment and focus the offer.

<p className="text-center mt-4">_↓ Scroll ↓_</p>

<Img className="relative max-w-5xl mt-8 w-full overflow-y-scroll h-full block p-0 md:p-0" src="/projects/makeit/webpage.png"/>

We managed to wire up a contact form into Airtable which led to a simple way for our team to track leads.

The following enabled us to setup a multistep form with some react state. Tracking visitors with posthog.
...
```
API routes handled through Next.
