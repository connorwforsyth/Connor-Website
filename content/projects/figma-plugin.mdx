...
However during an <Comment text="the project that kicked off this experiment">intranet project</Comment>, we used Figma to document the evaluation, as it enabled evaluators to take screenshots of the interfaces and directly markup the elements that were being analysed.
