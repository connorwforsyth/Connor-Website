...
## Work Snapshot:
<div className="grid relative z-10 grid-cols-1 gap-4 max-w-7xl mt-6 mx-auto lg:grid-cols-5 lg:h-96">
  <div className=" col-span-1 lg:col-span-3 rounded-lg overflow-hidden flex items-center justify-center">
  ...
  <div className=" col-span-1 rounded-lg overflow-hidden flex items-center justify-center">
    <img src="/projects/university-of-sydney/gallery-walk/g-3.jpeg" className="w-full h-full object-cover"alt="Gallery Walk Image 3"/>
  </div>
  <div className="col-span-1  rounded-lg overflow-hidden flex items-center justify-center">
    <img src="/projects/university-of-sydney/gallery-walk/g-2.jpeg" className="w-full h-full object-cover" alt="Gallery Walk Image 2"/>
  </div>
</div>
