...
<Img alt="Using subtle color filters allowed for a natural burnt in effect with on the #FDF4D8 background." className="lg:p-8 aspect-auto border-none bg-[#FDF4D8] dark:bg-[#FDF4D8]" src="/images/photo-inspiration.png" />
</MDXCarousel>
