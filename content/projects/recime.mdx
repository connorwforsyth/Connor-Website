...
date: "08-20-2024"
description: "ReciMe is a New York-based startup redefining how people organise, cook, and share recipes."
p2: "They launched an iOS app that has 1M users globally and generates $1M ARR, with projections of $3M by the end of 2024. To keep up with their growth trajectory, ReciMe is developing a web application that delivers and extends the current mobile experience to serve more users."
---

<Collaborators people="Christine Nguyen" />

<div className="relative z-10 flex w-full flex-col justify-center rounded-lg from-orange-300  to-orange-500 md:bg-gradient-to-r md:p-24">
<div className="mx-auto w-full max-w-5xl  rounded-[8px] border border-zinc-300 bg-zinc-300 p-[4px] shadow-md *:rounded-[4px] dark:bg-white dark:bg-opacity-50 md:rounded-[12px] md:bg-white md:bg-opacity-50 md:p-[8px] md:*:rounded-[4px]">
<iframe
...
Through a four-day product concept sprint, I designed an early prototype of the ReciMe homepage for desktop web users.
...
1. Getting acquainted with the product, iOS UI, potential user groups, and core customer jobs.
2. Using my understanding to produce a desktop concept of what the web application experience could be.

The intention would be to use this concept to align with ReciMe's view of their product strategy, and to take it to testing with different user groups.
...
Exploring and discovering recipes was hidden within the side menu. My immediate goal was to make finding recipes intuitive and consistent with patterns from familiar apps.
...
- Revamp UI elements and colours to improve accessibility and scalability, using a colour system from radix-ui and a grid system for spacing and alignment.
- Refine the existing logo for added polish and delight.

## Outcomes and deliverables

The new web home screen for ReciMe grounds users in core tasks, enables browsing of trending recipes, and allows searching by meal type, ingredients, and cuisines. It also hints at new features like receipt scanning for financial tracking and meal cost prediction.
...
Thanks to the ReciMe team for creating an awesome product and for the opportunity to take part in defining its future. I look forward to seeing where the remaining design choices lead the product and how it evolves into production.
