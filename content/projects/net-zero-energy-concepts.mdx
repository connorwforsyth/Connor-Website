...
<div>
    <div className="hidden md:block w-full max-w-5xl mx-auto rounded-[8px] border border-zinc-300 bg-zinc-300 p-[4px] shadow-md *:rounded-[4px] dark:bg-white dark:bg-opacity-50 md:rounded-[12px] md:border-white md:bg-white md:bg-opacity-50 md:p-[8px] md:*:rounded-[6px]">
    <iframe
    className="relative aspect-[3/2] w-full overflow-clip bg-white"
    style={{
          zoom: 0.66,
        }}
    src="https://embed.figma.com/design/lMP0N0ccmMFHejQKESZ1eb/Origin-Zero-x-Designit_-MBA-2.0-Redesign_-Advanced-Features-Exploration?node-id=26-46&embed-host=share allowfullscreen"/>
    
      </div>
      <Caption>Figma file containing the 10 aspirational features.</Caption>
</div>
