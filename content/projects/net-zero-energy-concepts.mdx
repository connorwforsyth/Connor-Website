...
This was a short snapshot reel that I created to playback the video with Designit's global townhall. We also produced video highlights to share reseearch findings with Origin Zero's stakeholders.

<iframe className="max-w-2xl mx-auto w-full h-96 rounded-lg" src="https://player.vimeo.com/video/916520968?h=f5f23cc6d5&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" title="[Internal] Designit Australia - Origin Zero Global Case Study"></iframe><script src="https://player.vimeo.com/api/player.js"></script>
