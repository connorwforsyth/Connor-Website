...
{/* const practicesData = [
  { practice: 'Wayfinding', tool: 'Miro', link: 'http://servdes2020.org' },
  { practice: 'Wireframing', tool: 'Adobe Illustrator', link: 'https://www.gather.town' },
  { practice: 'Visual Design', tool: 'Gather.Town', link: '' },
  { practice: 'Experience Design', tool: 'Google Sheets', link: '' },
  { practice: 'Storyboarding', tool: '', link: '' },
  { practice: 'Prototyping', tool: '', link: '' }
  ]; */}
...
![Initial wireframe / sketch of floor plan. Noting the separate spaces and activation areas for events.](../images/wireframe-of-gather-layout.png)

![Socialization asset of the map to encourage interaction before and after each event.](../images/gather.png)

### Interactions
The 8-bit game-like space created cool interactions.

![Socialization asset of the map to encourage interaction before and after each event.](../images/singage-banner.png "Map designed to facilitate socialization at ServDes2020")
